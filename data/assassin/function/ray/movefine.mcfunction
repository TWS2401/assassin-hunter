...
execute as @s[tag=!hit_block] unless block ^0.35 ^ ^ #assassin:ray_permeable run scoreboard players add @s RayHitL 1
execute as @s[tag=!hit_block] unless block ^-0.35 ^ ^ #assassin:ray_permeable run scoreboard players add @s RayHitR 1
execute as @s[tag=!hit_block] unless block ^ ^0.35 ^ #assassin:ray_permeable run scoreboard players add @s RayHitU 1
execute as @s[tag=!hit_block] unless block ^ ^-0.35 ^ #assassin:ray_permeable run scoreboard players add @s RayHitD 1
